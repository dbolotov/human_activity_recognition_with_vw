...
split.main('../data/working/dataset_gender_only_rand.vw','../data/working/train.vw','../data/working/test.vw', 0.0001, 'rand')
...
## csoaa
model_cmd = "vw -d ../data/working/train.vw -f ../data/output/vw.model --csoaa 5"
