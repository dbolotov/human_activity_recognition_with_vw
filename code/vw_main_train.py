...
split.main('../data/working/dataset.vw','../data/working/train.vw','../data/working/test.vw', 0.9999, 'rand')
...
## csoaa
model_cmd = "vw -d ../data/working/train.vw -f ../data/output/vw.model -c -k --csoaa 5 -l 0.5 --passes 3"
